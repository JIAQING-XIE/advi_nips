...
def plot_llk(train_elbo, test_elbo, method):
    ...
    plt.savefig("./vae_results/test_elbo_vae_{}.png".format(method))
    plt.close("all")
...
def mnist_test_tsne(vae=None, test_loader=None, method = None):
    """
    ...
    plot_tsne(z_loc, mnist_labels, name, method)
...
def plot_tsne(z_loc, classes, name, method):
    import matplotlib
    ...
    fig.savefig("./vae_results/" + str(name) + "_embedding_{}.png".format(method))